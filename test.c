...
void	ft_strlen_test(void)
{
	...
	puts("\n" COLGREEN "|_________ **** ft_strlen test **** _______|" COLRESET "\n");
...
void	ft_strcpy_test(void)
{
	...
	puts("\n" COLGREEN "|_______**** ft_strcpy test ****__________|" COLRESET "\n");
...
void	ft_strcmp_test()
{
	...
	puts("\n" COLGREEN "|________**** ft_strcmp test ****__________|" COLRESET "\n");
...
void	ft_write_test(void)
{
	...
	puts("\n" COLGREEN "|_________**** ft_write test ****_________|" COLRESET "\n");
...
void	ft_read_test(void)
{
	...
	puts("\n" COLGREEN "|___________**** ft_read test ****__________|" COLRESET "\n");
...
void	ft_strdup_test(void)
{
	...
	puts("\n" COLGREEN "|__________**** ft_strdup test ****__________|" COLRESET "\n");
